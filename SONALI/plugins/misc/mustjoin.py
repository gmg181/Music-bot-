    ...
    try:
        try:
            ...
            if MUST_JOIN.isalpha():
                link = "https://t.me/ironmanhindigming1" + MUST_JOIN
            else:
            ...
            try:
                await msg.reply_photo(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("• channel •", url="https://t.me/irotechlab"),
                            ],
                            [
                                InlineKeyboardButton("• support •", url="https://t.me/ironmanhindigming1"),
                            ]
                        ]
                    )
                )
